...
pub(crate) const VALID_SENSOR_TYPE_INT: [i32; 25] = [
    ffi::ASENSOR_TYPE_ACCELEROMETER as i32,
    ffi::ASENSOR_TYPE_MAGNETIC_FIELD as i32,
    ffi::ASENSOR_TYPE_GYROSCOPE as i32,
    ffi::ASENSOR_TYPE_LIGHT as i32,
    ffi::ASENSOR_TYPE_PROXIMITY as i32,
    ffi::ASENSOR_TYPE_GRAVITY as i32,
    ffi::ASENSOR_TYPE_LINEAR_ACCELERATION as i32,
    ffi::ASENSOR_TYPE_ROTATION_VECTOR as i32,
    ffi::ASENSOR_TYPE_RELATIVE_HUMIDITY as i32,
    ffi::ASENSOR_TYPE_AMBIENT_TEMPERATURE as i32,
    ffi::ASENSOR_TYPE_MAGNETIC_FIELD_UNCALIBRATED as i32,
    ffi::ASENSOR_TYPE_GAME_ROTATION_VECTOR as i32,
    ffi::ASENSOR_TYPE_GYROSCOPE_UNCALIBRATED as i32,
    ffi::ASENSOR_TYPE_SIGNIFICANT_MOTION as i32,
    ffi::ASENSOR_TYPE_STEP_DETECTOR as i32,
    ffi::ASENSOR_TYPE_STEP_COUNTER as i32,
    ffi::ASENSOR_TYPE_GEOMAGNETIC_ROTATION_VECTOR as i32,
    ffi::ASENSOR_TYPE_HEART_RATE as i32,
    ffi::ASENSOR_TYPE_POSE_6DOF as i32,
    ffi::ASENSOR_TYPE_STATIONARY_DETECT as i32,
    ffi::ASENSOR_TYPE_MOTION_DETECT as i32,
    ffi::ASENSOR_TYPE_HEART_BEAT as i32,
    ffi::ASENSOR_TYPE_LOW_LATENCY_OFFBODY_DETECT as i32,
    ffi::ASENSOR_TYPE_ACCELEROMETER_UNCALIBRATED as i32,
    ffi::ASENSOR_TYPE_INVALID as i32,
];
